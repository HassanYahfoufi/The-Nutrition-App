...
class CreateBlankPage extends StatefulWidget {
  const CreateBlankPage({required this.nextPage, super.key});
...
class _CreateBlankPageState extends State<CreateBlankPage> {
  ...
  Future<void> submit() async
  {
    ...
    } else //if you are here then the /*!!!!!*/required_var01 + required_var02/*!!!!!*/ combo hasn't been used yet
    {
      debugPrint(
          "[Create Blank_WSpace Page-> submit()] the combo of values for the required parameters hasn't been used yet");
  ...
  Widget currentPage({/*!!!!!*/required required_var01Controller, required required_var02Controller/*!!!!!*/, required optional_var01Controller, required optional_var02Controller, required optional_var03Controller, required optional_var04Controller/*!!!!!*/, required nonDB_var01Controller, required nonDB_var02Controller/*!!!!!*/}){ return Center(
